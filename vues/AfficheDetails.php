<article class="flex tousEgal column ml50 pageUneOeuvre">
    ...
    ?>
        ...
        ?>
            ...
            if($data[0]["arrondissement"]!=""){
                echo "<li><span>Arrondissement :<a href='./index.php?Public&action=afficheOeuvreslieu&idValue=". $data[0]["arrondissement"]. "'>". $data[0]["arrondissement"]. "</a></span></li>";
            }	
            ?>
                </ul>
            </section>
